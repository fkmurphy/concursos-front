                    ...
                    <table class="min-w-max w-full table-auto">
                        <thead>
                            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                ...
                                <th class="py-3 px-6 text-center">Cantidad de postulantes</th>
                        ...
                        <tbody class="text-gray-600 text-sm font-light">
                            <tr v-for="(item, index) in data" :key="index" class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <component :is="getComponent" :type="'status'" :color="green" :value="Ok" />
                                </td>
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                ...
                                <!--
                                <td>
                                    <component :is="getComponent" :value="item[columnIndex]" class="font-medium"></component>
                                </td>
                                ...
                                <td class="py-3 px-6 text-center">
                                    <span class="bg-purple-200 text-purple-600 py-1 px-3 rounded-full text-xs">Abierto</span>
                                </td>
                                <td class="py-3 px-6 text-center">
                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <span class="font-medium">Ciencias políticas</span>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-left">
                                    <div class="flex items-center">
                            ...
                            <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100">
                                <td class="py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        ...
                                        <span class="font-medium">Informática</span>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-left">
                                    <div class="flex items-center">
                                        <div class="mr-2">
                                            <img class="w-6 h-6 rounded-full" src="https://randomuser.me/api/portraits/men/2.jpg"/>
                                        </div>
                                        <span>Juan</span>
                                    </div>
                                </td>
